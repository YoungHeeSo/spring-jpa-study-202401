...
public interface StudentRepository extends JpaRepository<Student, String> {
    ...
    // 쿼리 메서드: 메서드 이름의 특별한 규칙을 적용하면 SQL이 규칙에 맞게 자동생성
    ...
    // Student getByCityWithJPQL(@Param("cc") String city);
    ...
    // JPQL 으로 삽입, 수정, 삭제 쿼리 사용하는 방법
    @Modifying // select가 아닌경우 무조건 붙이기(select 이외에 다 붙여버려)
